...
triggerType | string | resize 또는 resize.responsive 이벤트를 trigger 또는 triggerHandler로 호출했을때 어떤 메소드로 호출했는지 나타내는 변수입니다. trigger 또는 triggerHandler에의한 호출이 아니라면 none이 나옵니다.
